...
import sys, os
sys.path.append(os.environ['scriptLib']+'/MSR605-Card-Reader-Writer-Eraser-with-GUI')

import cardReader
__msr = cardReader.CardReader()
__msr.reset()
__msr.set_hi_co()



def _interact_magswipe():
...
def _seed(current_content_track1 = '', current_content_track2 = '', current_content_track3 = ''):
	__msr.write_card([current_content_track1, current_content_track2, current_content_track3+'?'], True)
